...
onMounted(async () => {
    product.value = await getProduct(useRoute().params.id as UUID);
})
...
//     經典不敗，穿出質感日常 <br>
//     ✨做工精緻 <br>
//     ✨琥珀鈕扣點綴更讓質感更具提升,手袖添加3顆琥珀鈕扣設計 <br>
//     <br>
//     <br>
//     👉🏻 換季時的必備單品 <br>
//     早晚微涼的天氣，外面隨手帶件西裝外套，保暖剛剛好，還能讓整體穿搭更完整 <br>
//     <br>
//     👉🏻不用想太多，這件就對了 <br>
//     T-shirt＋牛仔褲有點太隨性？外面加件西裝外套，剛剛好的正式感，連今天的咖啡都喝得更有儀式感了 <br>
//     搭配裙子更優雅了 <br>
//     <br>
//     帶溫柔感的米杏色和知性灰色 <br>
//     你最愛哪色呢💗💗 <br>
...
<template>
    ...
    <ProductLayout>
        ...
        <template #product-image>
            <ProductImage :item="product" :isLabel="false"></ProductImage>
        </template>
